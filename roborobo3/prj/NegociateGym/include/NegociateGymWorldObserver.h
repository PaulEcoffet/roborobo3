...
#ifndef ROBOROBO3_NEGOCIATEGYMWORLDOBSERVER_H
#define ROBOROBO3_NEGOCIATEGYMWORLDOBSERVER_H


#include <Observers/WorldObserver.h>
#include <World/World.h>
#include <network/PyroboroboInterface.h>
#include <gzstream.h>
#include <queue>
...
class NegociateGymWorldObserver : public WorldObserver
{
public:
    explicit NegociateGymWorldObserver(World *__world);

    ~NegociateGymWorldObserver() override;
...
protected:
    ...
    PyroboroboInterface pyroborobo;
    ...
    void mark_robots_on_opp(NegociateGymOpportunity *opp) const;
...
#endif //ROBOROBO3_NEGOCIATEGYMWORLDOBSERVER_H

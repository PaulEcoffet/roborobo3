...
#ifndef ROBOROBO3_NEGOCIATEGYMSHAREDDATA_H
#define ROBOROBO3_NEGOCIATEGYMSHAREDDATA_H


class NegociateGymSharedData
{
public:
    ...
    static double mutProbNegociateGym;
...
#endif //ROBOROBO3_NEGOCIATEGYMSHAREDDATA_H

...
public:
    ...
    void wasNearObject( int __objectId, bool __objectDidMove, double __gain, int __nbRobots ); // callback from the object whose footprint we're on, telling us how much it moved

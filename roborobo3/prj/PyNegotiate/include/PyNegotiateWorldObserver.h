...
#ifndef ROBOROBO3_PYNEGOTIATEWORLDOBSERVER_H
#define ROBOROBO3_PYNEGOTIATEWORLDOBSERVER_H
...
protected:
    ...
    void mark_robots_on_opp(PyNegotiateOpportunity *opp) const;
...
#endif //ROBOROBO3_PYNEGOTIATEWORLDOBSERVER_H

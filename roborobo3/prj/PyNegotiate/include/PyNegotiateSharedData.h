...
#ifndef ROBOROBO3_PYNEGOTIATESHAREDDATA_H
#define ROBOROBO3_PYNEGOTIATESHAREDDATA_H


class PyNegotiateSharedData
{
public:
    ...
    static double mutProbPyNegotiate;
...
#endif //ROBOROBO3_PYNEGOTIATESHAREDDATA_H

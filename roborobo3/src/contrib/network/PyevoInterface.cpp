...
{
    std::vector<double> mutprob(parameters_dimension, 1.0/(parameters_dimension*popsize));
    return initCMA(popsize, parameters_dimension, minbounds, maxbounds, minguess, maxguess, std, mutprob);
